...
public class TrabalhadorContaOutrem extends ContribuinteComRendimentosTrabalho
{
    ...
    /**
     * Valor da taxa de nível 1 sobre o rendimento do trabalho
     */
    private static double taxaRendimentosTrabalhoNivel1 = 0.01;

    /**
     * Valor da taxa de nível 2 sobre o rendimento do trabalho
     */
     ...
     */
    private static final double LIMITE_RENDIMENTOS_TRABALHO = 30000;
    ...
    /**
     * Modifica o valor da taxa de nível 1 rendimentos do trabalho
     *
    ...
    /**
     * Modifica o valor da taxa de nível 2 rendimentos do trabalho
     *
